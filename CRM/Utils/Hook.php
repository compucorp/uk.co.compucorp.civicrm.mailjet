...
abstract class CRM_Utils_Hook {
   ...
   * @param int $jobID - the job id for the email which is being invoked.
   * Hacked for mailjet
   */
  static function alterMailParams(&$params, $context = NULL, $jobID = NULL) {
    return self::singleton()->invoke(3, $params, $context, $jobID, self::$_nullObject, self::$_nullObject,
